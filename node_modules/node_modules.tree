...
│   ├── md2html -> ../markdown/bin/md2html.js
│   ├── mime -> ../mime/cli.js
│   ├── mkdirp -> ../mkdirp/bin/cmd.js
│   ├── ncp -> ../ncp/bin/ncp
│   ├── nopt -> ../nopt/bin/nopt.js
│   ├── nunjucks-precompile -> ../nunjucks/bin/precompile
│   ├── postinstall-build -> ../postinstall-build/cli.js
│   ├── rimraf -> ../rimraf/bin.js
│   ├── stylus -> ../stylus/bin/stylus
│   ├── swig -> ../swig-templates/bin/swig.js
│   ├── to-title-case -> ../titlecase/bin.js
